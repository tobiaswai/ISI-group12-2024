...
urlpatterns = [
    ...
    path('add_images/', views.addImageView.as_view(), name="add_images"),
    path('product_images/<int:product_id>', views.Productphotos, name="product_images"),
    path('update_images/<int:pk>/', views.updateImageView.as_view(), name="update_images"),
